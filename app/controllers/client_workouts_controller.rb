  ...
  def create
    ...
    respond_to do |format|
      if @client_workout.save
        format.html { redirect_to(@client_workout, :notice => 'ClientWorkout was successfully created.') }
  ...
  def update
    ...
    respond_to do |format|
      if @client_workout.update_attributes(params[:client_workout])
        format.html { redirect_to(@client_workout, :notice => 'ClientWorkout was successfully updated.') }
        format.xml  { head :ok }
      else
